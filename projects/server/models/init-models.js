...
function initModels(sequelize) {
  ...
  JournalItem.belongsTo(JournalType, {
    as: "journal_type",
    foreignKey: "journal_type_id",
  })
  JournalType.hasMany(JournalItem, {
    as: "journal_items",
    foreignKey: "journal_type_id",
  })
  JournalItem.belongsTo(Journal, { as: "journal", foreignKey: "journal_id" })
  Journal.hasMany(JournalItem, {
    as: "journal_items",
  ...
  StockRequestItem.belongsTo(Product, {
    as: "product",
    foreignKey: "product_id",
  })
  Product.hasMany(StockRequestItem, {
    as: "stock_request_items",
    foreignKey: "product_id",
  })
  ...
  JournalItem.belongsTo(Warehouse, {
    as: "warehouse",
    foreignKey: "warehouse_id",
  })
  Warehouse.hasMany(JournalItem, {
    as: "journal_items",
    foreignKey: "warehouse_id",
  })
  ...
  StockRequest.belongsTo(Warehouse, {
    as: "from_warehouse",
    foreignKey: "from_warehouse_id",
  })
  Warehouse.hasMany(StockRequest, {
    as: "stock_requests",
    foreignKey: "from_warehouse_id",
  })
  StockRequest.belongsTo(Warehouse, {
  ...
  Warehouse.hasMany(StockRequest, {
    as: "to_warehouse_stock_requests",
    foreignKey: "to_warehouse_id",
  })
  Warehousesuser.belongsTo(Warehouse, {
    as: "warehouse",
    foreignKey: "warehouse_id",
  })
  Warehouse.hasMany(Warehousesuser, {
    as: "warehousesusers",
    foreignKey: "warehouse_id",
  })
